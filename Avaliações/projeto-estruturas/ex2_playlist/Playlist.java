...
public class Playlist {
    ...
    // Cada nó contém dados da música + ponteiros anterior e próximo
    // =========================================================
    ...
    // =========================================================
    // LISTA DUPLAMENTE LIGADA - GERENCIADOR DE PLAYLIST
    // =========================================================
    static class ListaPlaylist {
        private NoMusica cabeca;  // primeiro nó
        private NoMusica cauda;   // último nó
        private NoMusica atual;   // música sendo "tocada" agora
        private int tamanho;
        ...
        // Adiciona música no INÍCIO da lista
        void adicionarInicio(String titulo, String artista, String album, int duracao) {
            ...
            if (cabeca == null) {
                cabeca = novo;
                cauda = novo;
                atual = novo; // primeira música vira a atual
            } else {
                novo.proximo = cabeca;
        ...
        // Adiciona música no FIM da lista
        ...
        // Adiciona música em posição específica (1-based)
        void adicionarPosicao(String titulo, String artista, String album, int duracao, int posicao) {
            ...
            // cursor está no nó ANTES da posição desejada
        ...
        // Remove música pelo título (case-insensitive)
        ...
        // Remove música pela posição (1-based)
        ...
        // Método interno: desconecta um nó da lista e atualiza ponteiros
        private void removerNo(NoMusica no) {
            if (no == atual) {
                // Se removemos a música atual, avança para a próxima (ou anterior)
                if (no.proximo != null) {
                    atual = no.proximo;
        ...
        // ── ORDENAÇÃO (Bubble Sort na lista ligada) ───────────
        ...
        // Troca apenas os DADOS entre dois nós (mantém os ponteiros)
    ...
    public static void main(String[] args) {
        ...
        // Pré-carrega músicas de exemplo
